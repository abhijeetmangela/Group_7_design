...
\subsubsection{Senthil B AE23M035}
Calculated power loading calculations for cruise climb descent,loitre and stall conditions. Also calculated and approximated some design parameters like wing reference area, maximum Lift to Drag Ratio ueing previously collected data.
